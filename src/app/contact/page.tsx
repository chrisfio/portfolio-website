        ...
        <div className="bg-white bg-opacity-5 rounded-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-xl mx-auto">
            <a 
              ...
              className="flex flex-col items-center p-6 bg-white bg-opacity-5 rounded-lg hover:bg-opacity-10 transition-all"
            >
              ...
              <span className="text-sm text-[#a0a0a0]">your.email@example.com</span>
            </a>
